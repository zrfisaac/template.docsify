...
var pt = {
  ...
  return typeof e != "string" && (e = e.unit), e in pt || e in aa || e === "ex";
}, K = function(e, t) {
  var a;
  if (e.unit in pt)
    a = pt[e.unit] / t.fontMetrics().ptPerEm / t.sizeMultiplier;
  else if (e.unit === "mu")
...
class f0 {
  constructor(e, t, a, n, l, u, h, c) {
    ...
    var p = W1(this.text.charCodeAt(0));
...
var s = "math", w = "text", o = "main", d = "ams", j = "accent-token", D = "bin", o0 = "close", ie = "inner", E = "mathord", e0 = "op-token", p0 = "open", ce = "punct", f = "rel", q0 = "spacing", v = "textord";
i(s, o, f, "≡", "\\equiv", !0);
i(s, o, f, "≺", "\\prec", !0);
i(s, o, f, "≻", "\\succ", !0);
i(s, o, f, "∼", "\\sim", !0);
...
for (var l0 = 0; l0 < Ee.length; l0++) {
  var J = Ee.charAt(l0);
  R = String.fromCharCode(55349, 56320 + l0), i(s, o, E, J, R), i(w, o, v, J, R), R = String.fromCharCode(55349, 56372 + l0), i(s, o, E, J, R), i(w, o, v, J, R), R = String.fromCharCode(55349, 56424 + l0), i(s, o, E, J, R), i(w, o, v, J, R), R = String.fromCharCode(55349, 56580 + l0), i(s, o, E, J, R), i(w, o, v, J, R), R = String.fromCharCode(55349, 56684 + l0), i(s, o, E, J, R), i(w, o, v, J, R), R = String.fromCharCode(55349, 56736 + l0), i(s, o, E, J, R), i(w, o, v, J, R), R = String.fromCharCode(55349, 56788 + l0), i(s, o, E, J, R), i(w, o, v, J, R), R = String.fromCharCode(55349, 56840 + l0), i(s, o, E, J, R), i(w, o, v, J, R), R = String.fromCharCode(55349, 56944 + l0), i(s, o, E, J, R), i(w, o, v, J, R), l0 < 26 && (R = String.fromCharCode(55349, 56632 + l0), i(s, o, E, J, R), i(w, o, v, J, R), R = String.fromCharCode(55349, 56476 + l0), i(s, o, E, J, R), i(w, o, v, J, R));
}
...
for (var Y0 = 0; Y0 < 10; Y0++) {
  var H0 = Y0.toString();
  R = String.fromCharCode(55349, 57294 + Y0), i(s, o, E, H0, R), i(w, o, v, H0, R), R = String.fromCharCode(55349, 57314 + Y0), i(s, o, E, H0, R), i(w, o, v, H0, R), R = String.fromCharCode(55349, 57324 + Y0), i(s, o, E, H0, R), i(w, o, v, H0, R), R = String.fromCharCode(55349, 57334 + Y0), i(s, o, E, H0, R), i(w, o, v, H0, R);
}
var gt = "ÐÞþ";
for (var tt = 0; tt < gt.length; tt++) {
  var ke = gt.charAt(tt);
  i(s, o, E, ke, ke), i(w, o, v, ke, ke);
}
var Se = [
  ...
  if (h) {
    var p = h.italic;
    (a === "text" || n && n.font === "mathit") && (p = 0), c = new f0(e, h.height, h.depth, p, h.skew, h.width, l);
  } else
  ...
  if (c) {
    ...
    if (c === "boldsymbol") {
      ...
      h ? (b = bt[c].fontName, y = [c]) : (b = ze(c, t.fontWeight, t.fontShape), y = [c, t.fontWeight, t.fontShape]);
    if (He(l, b, n).metrics)
  ...
  for (var e = 0; e < r.length - 1; e++) {
    var t = r[e], a = r[e + 1];
    t instanceof f0 && a instanceof f0 && va(t, a) && (t.text += a.text, t.height = Math.max(t.height, a.height), t.depth = Math.max(t.depth, a.depth), t.italic = a.italic, r.splice(e + 1, 1), e--);
  }
  return r;
}, Et = function(e) {
  ...
  for (var g = [], b = n, y = n, x = n, M = 0; M < a.length; M++) {
    ...
    if (T.type === "kern")
      ...
      var C = T.elem, q = T.wrapperClasses || [], I = T.wrapperStyle || {}, O = k(q, [p, C], void 0, I);
...
var Ne = function(e) {
  ...
  for (var u = 0; u < e.length; u++) {
    ...
    p ? a.node = h : l && h.hasClass("newline") && (a.node = k(["leftmost"])), a.insertAfter = ((b) => (y) => {
      e.splice(b + 1, 0, y), u++;
    })(u);
  }
  n && e.pop();
...
function kt(r, e) {
  ...
  for (var l = [], u = [], h = 0; h < a.length; h++)
    if (u.push(a[h]), a[h].hasClass("mbin") || a[h].hasClass("mrel") || a[h].hasClass("allowbreak")) {
      ...
      a[h].hasClass("newline") && (u.pop(), u.length > 0 && (l.push(Ae(u, e)), u = []), l.push(a[h]));
  u.length > 0 && l.push(Ae(u, e));
  var p;
  t ? (p = Ae(a0(t, e, !0), e), p.classes = ["tag"], l.push(p)) : n && l.push(n);
...
var Xr = function(e) {
  ...
  if (/fbox|color|angl/.test(t)) {
    ...
    var p = [];
    /^[bx]cancel$/.test(t) && p.push(new vt({
      x1: "0",
      y1: "0",
      x2: "100%",
      y2: "100%",
      "stroke-width": "0.046em"
    })), /^x?cancel$/.test(t) && p.push(new vt({
      x1: "0",
      y1: "100%",
      x2: "100%",
      y2: "0",
...
var Wr = (r) => {
  ...
  if (u) {
    var c, p;
    h = (c = (p = Wr(l)) == null ? void 0 : p.skew) != null ? c : 0;
  }
          ...
          if ("<>AV".includes(p))
            for (var b = 0; b < 2; b++) {
              for (var y = !0, x = c + 1; x < u.length; x++) {
                ...
                if (or(u[x]))
                  throw new S("Missing a " + p + " character to complete a CD arrow.", u[x]);
                g[b].body.push(u[x]);
              }
              if (y)
                throw new S("Missing a " + p + " character to complete a CD arrow.", u[c]);
            }
          else
...
var ue = function(e, t, a) {
  ...
  var M = ue(h, x, l), T = M.height + M.depth, C = ue(p, x, l), q = C.height + C.depth, I = ue(g, x, l), O = I.height + I.depth, F = 0, V = 1;
  if (c !== null) {
    var L = ue(c, x, l);
  ...
  if (b.length > 0) {
    ...
    if (t0.push(at(g, x, l)), t0.push(Te), c === null) {
      ...
      t0.push(nt(p, se, n)), t0.push(Te), t0.push(at(c, x, l)), t0.push(Te), t0.push(nt(p, se, n));
    }
  ...
  return n.type === "small" ? (g = 1e3 + 1e3 * u + it, e < 1 ? l = 1 : e < 1.4 && (l = 0.7), c = (1 + u + lt) / l, p = (1 + u) / l, h = st("sqrtMain", c, g, u, t), h.style.minWidth = "0.853em", b = 0.833 / l) : n.type === "large" ? (g = (1e3 + it) * oe[n.size], p = (oe[n.size] + u) / l, c = (oe[n.size] + u + lt) / l, h = st("sqrtSize" + n.size, c, g, u, t), h.style.minWidth = "1.02em", b = 1 / l) : (c = e + u + lt, p = e + u, g = Math.floor(1e3 * e + u) + it, h = st("sqrtTall", c, g, u, t), h.style.minWidth = "0.742em", b = 1.056), h.height = p, h.style.height = A(c), {
    span: h,
    advanceWidth: b,
  ...
  for (var l = Math.min(2, 3 - n.style.size), u = l; u < a.length; u++) {
    ...
    if (h.type === "stack")
      break;
    var c = ue(e, ja(h), "math"), p = c.height + c.depth;
    if (h.type === "small") {
...
var Ye = (r, e) => {
  ...
  if (a === "sout")
    ...
    l = G0(["hide-tail"], [M], e), l.style.height = A(b), u = t.depth + c + p;
  } else {
  ...
  for (
    ...
    if (!(n >= h)) {
      ...
      for (a = 0; a < l; ++a) {
        ...
        if (ve) {
          var T1 = pe.pos - t0;
          ve.depth = pe.depth, ve.height = pe.height, $t.push({
            type: "elem",
            elem: ve,
            shift: T1
          });
...
var Qa = (r, e) => {
  ...
  if (g) {
    ...
    x - u.depth - (I + 0.5 * b) < M && (x += M - (x - u.depth - (I + 0.5 * b))), I - 0.5 * b - (p.height - T) < M && (T += M - (I - 0.5 * b - (p.height - T)));
    var O = -(I - 0.5 * b);
    C = G({
      positionType: "individualShift",
      children: [{
...
var pr = ["display", "text", "script", "scriptscript"], vr = function(e) {
  var t = null;
...
B({
  ...
  handler(r, e) {
    var {
      parser: t
    } = r, a = e[4], n = e[5], l = Ne(e[0]), u = l.type === "atom" && l.family === "open" ? vr(l.text) : null, h = Ne(e[1]), c = h.type === "atom" && h.family === "close" ? vr(h.text) : null, p = H(e[2], "size"), g, b = null;
    ...
    if (x.type === "ordgroup") {
      ...
      x = H(x, "textord"), y = pr[Number(x.text)];
    return d1({
      type: "genfrac",
      mode: t.mode,
      numer: a,
...
var p1 = (r, e, t, a, n, l, u) => {
...
}, v1 = /* @__PURE__ */ new Set(["\\smallint"]), le = (r, e) => {
  var t, a, n = !1, l;
  r.type === "supsub" ? (t = r.sup, a = r.sub, l = H(r.base, "op"), n = !0) : l = H(r, "op");
  var u = e.style, h = !1;
  u.size === N.DISPLAY.size && l.symbol && !v1.has(l.name) && (h = !0);
  var c;
  if (l.symbol) {
    var p = h ? "Size2-Regular" : "Size1-Regular", g = "";
    if ((l.name === "\\oiint" || l.name === "\\oiiint") && (g = l.name.slice(1), l.name = g === "oiint" ? "\\iint" : "\\iiint"), c = s0(l.name, p, "math", e, ["mop", "op-symbol", h ? "large-op" : "small-op"]), g.length > 0) {
  ...
  var C = 0, q = 0;
  return (c instanceof f0 || l.name === "\\oiint" || l.name === "\\oiiint") && !l.suppressBaseShift && (C = (c.height - c.depth) / 2 - e.fontMetrics().axisHeight, q = c.italic || 0), n ? p1(c, t, a, e, u, q, C) : (C && (c.style.position = "relative", c.style.top = A(C)), c);
}, de = (r, e) => {
  var t;
  if (r.symbol)
    t = new z("mo", [b0(r.name, r.mode)]), v1.has(r.name) && t.setAttribute("largeop", "false");
  else if (r.body)
...
var g1 = (r, e) => {
  ...
  if (l.body.length > 0) {
    ...
    }), c = a0(h, e.withFont("mathrm"), !0), p = 0; p < c.length; p++) {
      var g = c[p];
...
B({
  ...
  mathmlBuilder: (r, e) => {
    var t = v0(Q(r.body), e), a = new z("mphantom", t), n = new z("mpadded", [a]);
...
B({
  ...
  mathmlBuilder(r, e) {
    var t = yr[r.style], a = e.havingStyle(t), n = v0(r.body, a), l = new z("mstyle", n), u = {
      display: ["0", "true"],
      text: ["0", "false"],
      script: ["1", "false"],
...
$0({
  ...
  htmlBuilder(r, e) {
    ...
    var {
      ...
      sup: n,
      sub: l
    } = r, u = U(a, e), h, c, p = e.fontMetrics(), g = 0, b = 0, y = a && C0(a);
    if (n) {
    ...
    var C = e.sizeMultiplier, q = A(0.5 / p.ptPerEm / C), I = null;
    if (c) {
...
m("\\dots", function(r) {
  ...
  return t in Tr ? e = Tr[t] : (t.slice(0, 4) === "\\not" || t in $.math && p4.has($.math[t].group)) && (e = "\\dotsb"), e;
});
var Pt = {
...
var w1 = A(k0["Main-Regular"]["T".charCodeAt(0)][1] - 0.7 * k0["Main-Regular"]["A".charCodeAt(0)][1]);
    ...
    if (typeof n == "string") {
      ...
      if (n.includes("#"))
        for (var u = n.replace(/##/g, ""); u.includes("#" + (l + 1)); )
          ++l;
      for (var h = new Ar(n, this.settings), c = [], p = h.lex(); p.text !== "EOF"; )
        c.push(p), p = h.lex();
      c.reverse();
      var g = {
        tokens: c,
...
class je {
  ...
  parseSymbol() {
    ...
    if ($[this.mode][t]) {
      ...
      var h = $[this.mode][t].group, c = c0.range(e), p;
